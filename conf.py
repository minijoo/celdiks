...
BLOG_AUTHOR = "Joseph S. Lawrence"  # (translatable)
BLOG_TITLE = "Celdiks Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://celdiks.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://celdiks.com/"
BLOG_EMAIL = "minijoo@gmail.com"
BLOG_DESCRIPTION = "Updates about the Boston Celtics and other things"  # (translatable)
